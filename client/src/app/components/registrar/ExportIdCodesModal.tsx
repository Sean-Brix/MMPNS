...
export const ExportIdCodesModal: React.FC<ExportIdCodesModalProps> = ({ open, onClose, students }) => {
    ...
    <Modal open={open} onClose={onClose} maxW="max-w-md">
      ...
      <div className="p-5 space-y-4">
        ...
        <p className="text-xs text-gray-400">
          Includes student name, grade level, section, LRN, and emergency contact info beside each {codeType === 'qr' ? 'QR code' : 'barcode'} — {filtered.length} student{filtered.length !== 1 ? 's' : ''} match the current filters.
        </p>
